...
class Evaluacion1Type extends AbstractType
{
    ...
    {
        $builder
		        ->add('proceso','textarea', array('required' => false, 'label' => ' ', 'max_length' => '600' , 'read_only' => true, 'attr' => array('cols' => '130', 'rows' => '25')))
				->add('herramientas','textarea', array('required' => false, 'label' => ' ', 'max_length' => '600' , 'read_only' => true, 'attr' => array('cols' => '130', 'rows' => '25')))
				...
				->add('comentarioAcademico','textarea', array('required' => false, 'label' => ' ', 'max_length' => '500', 'attr' => array('cols' => '130', 'rows' => '10')))
				->add('compromiso','textarea', array('required' => false, 'label' => ' ', 'max_length' => '500' , 'read_only' => true, 'attr' => array('cols' => '130', 'rows' => '10')));
