    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
		...
		switch($this->numase){
			case 1:	
				...
				$builder->add('docPracticante1','textarea', array('label' => 'Tu practicante indica:' , 'read_only' => true,  'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 2:
				...
				$builder->add('docPracticante2','textarea', array('label' => 'Tu practicante indica:' , 'read_only' => true, 'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 3:
				...
				$builder->add('docPracticante3','textarea', array('label' => 'Tu practicante indica:', 'read_only' => true,'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 4:
				...
				$builder->add('docPracticante4','textarea', array('label' => 'Tu practicante indica:', 'read_only' => true, 'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 5:
				...
				$builder->add('docPracticante5','textarea', array('label' => 'Tu practicante indica:', 'read_only' => true, 'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 6:
				...
				$builder->add('docPracticante6','textarea', array('label' => 'Tu practicante indica:', 'read_only' => true,'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
			case 7:
				...
				$builder->add('docPracticante7','textarea', array('label' => 'Tu practicante indica:', 'read_only' => true,'max_length' => '500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				break;
		}	
