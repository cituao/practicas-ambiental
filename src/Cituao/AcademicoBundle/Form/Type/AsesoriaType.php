...
class AsesoriaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
		...
		switch($this->numase){
			case 1:	
				$builder->add('docAsesor1','textarea', array('label' => 'Tu reflexión del proceso:',  'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				...
				break;
			case 2:
				$builder->add('docAsesor2','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				...
				break;
			case 3:
				$builder->add('docAsesor3','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => true ));
				...
				break;
			case 4:
				$builder->add('docAsesor4','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				...
				break;
			case 5:
				$builder->add('docAsesor5','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				...
				break;
			case 6:
				$builder->add('docAsesor6','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
				...
				break;
			case 7:
				$builder->add('docAsesor7','textarea', array('label' => 'Tu reflexión del proceso:', 'max_length' => '5500', 'attr' => array('placeholder' => 'Escriba sus comentarios sobre el proceso!' , 'cols' => '125', 'rows' => '10'), 'required' => false ));
