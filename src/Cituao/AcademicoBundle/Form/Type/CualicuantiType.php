...
class CualicuantiType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
				...
				->add('porcentaje1', 'choice', array('label' => 'Porcentaje', 'read_only' => true, 'choices'=> array('25' => '25%', '50' => '50%' , '75' => '75%')))	
				...
				->add('porcentaje2', 'choice', array('label' => 'Porcentaje', 'read_only' => true,'choices'=> array('25' => '25%', '50' => '50%' , '75' => '75%')))	
				...
				->add('porcentaje3', 'choice', array('label' => 'Porcentaje', 'read_only' => true, 'choices'=> array('25' => '25%', '50' => '50%' , '75' => '75%')))	
