...
class Evaluacion2Type extends AbstractType
{
    ...
    {
        $builder
		        ->add('required' => false, 'cumplido','textarea', array('required' => false, 'label' => ' ', 'max_length' => '600' , 'read_only' => true, 'attr' => array('cols' => '130', 'rows' => '10')))
...
('cols' => '130', 'rows' => '10')))
				...
				->add('compromisop','textarea', array('required' => false, 'label' => ' ', 'max_length' => '500' , 'read_only' => true, 'attr' => array('cols' => '130', 'rows' => '10')));
