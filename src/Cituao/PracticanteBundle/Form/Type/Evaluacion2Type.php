...
('cols' => '130', 'rows' => '10')))
				...
				->add('comentarioAcademico','textarea', array('label' => ' ', 'max_length' => '500', 'read_only' => true,'attr' => array('cols' => '130', 'rows' => '10')))
				->add('compromisop','textarea', array('label' => ' ', 'max_length' => '500','attr' => array('cols' => '130', 'rows' => '10')));
		}
    ...
    {
        return 'evaluacion2_practicante';
    }
}
